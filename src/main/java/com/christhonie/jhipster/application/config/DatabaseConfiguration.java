package com.christhonie.jhipster.application.config;
...
@Configuration
@EnableJpaRepositories("com.christhonie.jhipster.application.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.christhonie.jhipster.application.repository.search")
